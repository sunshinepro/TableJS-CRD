    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (let object of objects) {
          ...
          trHTML += '<td><button type="button" class="btn btn-outline-secondary" onclick="showUserBox('+object['id']+')">Details</button>';
...
//   Show user's details pop-up form
...
//   Show user's details by id onclick
  function userDetail() {
    ...
    const xhttp = new XMLHttpRequest();
    xhttp.open("GET", "https://www.mecallapi.com/api/users/update");
